...
for embedding in ["gpt2_tiny_wpetrain"]:
    ...
    plt.title("Sample complexity of 4-layer 4-head\ntransformer on parity with n=30", fontsize=20)
    ...
    plt.tight_layout()
    plt.show()
    plt.savefig("Figures/Figs/fig2.3.pdf")
    plt.savefig("Figures/Figs/fig2.3.svg")