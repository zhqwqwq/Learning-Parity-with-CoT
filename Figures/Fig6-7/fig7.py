...
for text_type in ['notonlyanswer','onlyanswer']:
    for average_type in ['min', 'average']:
        ...
        bar_width = 1
        fig, axs = plt.subplots(7, 4, figsize=(31, 45))  
        ...
        fig.legend(handles, labels, loc='lower center', fontsize=30, bbox_to_anchor=(0.93, 0.5), frameon=False)
        plt.tight_layout(rect=[0, 0, 0.83, 1])
        plt.show()
        plt.savefig(f'Figures/Figs/fig7r.pdf')